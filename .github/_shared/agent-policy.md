...
本ファイルは RadianNs_WebSite で作業する Claude・Codex・GitHub Copilot などに共通する運用ポリシーの正本です。
...
- 作品設定、キャラクター設定、掲載内容、権利表記、公開方針は作者管理領域とする。明示的な依頼なしに本文を生成・確定・改変しない。
...
- `.private/` 以下の情報を公開対象やコミット対象へ混入させない。
